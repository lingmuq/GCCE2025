...
# --- BN_layer（パターンB：最後のBottleneck出力のみCBAM適用） ---
class BN_layer(nn.Module):
    def __init__(self,
        ...
        # CBAM（最後の出力のみ）
        self.cbam_last = CBAM(512 * block.expansion)
